...
An intentionally opinionated, anonymous-first chat platform built with Rust (Axum) and Next.js. RChat makes unconventional design choices that prioritize user freedom and casual communication over traditional security practices.
...
**Rationale:** Password complexity requirements create friction for casual, anonymous communication. Users should be free to choose trivial passwords if they want disposable, low-stakes accounts. This platform is designed for ephemeral conversation, not sensitive data storage.
